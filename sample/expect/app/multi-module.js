                ...
                S.use([
                    ...
                    if (visitStat) {
                        ...
                        function onScroll(scrollHeight) {
                            ...
                            visitStat.maxScrollTop = Math.max(visitStat.maxScrollTop, DOM.scrollTop());    //Event.remove(doc,"scroll",onScroll);
                        }
                    ...
                    S.ready(function () {
                        util.initHover();
                        if (!isDaily)
                            S.getScript('http://a.tbcdn.cn/apps/lz/hc.js?v=5');    //因为combo文件的格式问题，这个文件不能用loadAssets方式combo
                    });
                });
            }
            if (!delayInit) {
